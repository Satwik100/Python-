...
"color:rgb(231, 251, 255)")
        ...
        self.tusername = QtWidgets.QLineEdit(self.horizontalLayoutWidget)
        ...
        self.horizontalLayout.addWidget(self.tusername)
        ...
        self.tpassword = QtWidgets.QLineEdit(self.horizontalLayoutWidget_2)
        ...
        self.horizontalLayout_2.addWidget(self.tpassword)
...
"")
        ...
        self.pclear.clicked.connect(self.tusername.clear)
        self.pclear.clicked.connect(self.tpassword.clear)
